...
export default function WW() {
  return (
    <article className="prose prose-neutral dark:prose-invert mx-auto max-w-3xl px-4 pb-20 sm:px-6">
      ...
      <p>
        RBE 2002 is a class at Worcester Polytechnic Institute called Robotics: Sensing. The goal of the class is to
        teach students about sensors and feedback control loops. As part of the final project for the class,
      ...
      <p>
        I built this robot was with two other robotics engineers at WPI, Ayesha Fathima and Wut Yee Oo, for a class
        called RBE 2002. The challenge for the class was to build a robot to clean windows on high-rise buildings
        while applying a constant pressure against the window surface as it moved about.
      </p>
      <p>
        ...
        moved with constant rotational velocity, there was no overall torque applied on the robot so there was very
        little shakiness as the robot washed. Because of how elegantly and uniquely it completed the challenge, we
        had the honor of the WPI robotics lab preserving our robot in a glass case at the end of the year.
      </p>
      ...
      <p>
        ...
        with bolts. The sensors and gears used are part of the Vex consctruction set and include two limit switches,
        a pushbutton, a linear potentiometer, and an encoder. The software PID controller was programmed into an
        Arduino microcontroller by all three of us.
      </p>
