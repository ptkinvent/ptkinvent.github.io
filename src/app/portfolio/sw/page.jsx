  ...
  return (
    <article className="prose prose-neutral dark:prose-invert mx-auto max-w-3xl px-4 pb-20 sm:px-6">
      ...
      <p>
        ...
        engineers, called computer-aided design (CAD) software. Having taught myself the software in high school, I
        had everything I needed to become their first high school intern ever.
      </p>
      <p>
        ...
        lead and face of Let's Go Design, among many others, to design and build what we called The Ultimate Office
        &mdash; our vision of the next-generation office cubicle.
      </p>
