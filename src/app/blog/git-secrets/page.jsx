...
export async function generateMetadata() {
  const blog = blogs.find((blog) => blog.id === "git-secrets");
        ...
        <div className="row">
          <div className="offset-md-2 col-md-8" id="description">
            <p>
              ...
              commands&mdash;committing, branching, and merging. But there's actually much more hidden depth to Git than
              you might expect. So much so, in fact, that it could change the way you work. For one thing, your commit
              history is much more fluid than you might assume&mdash;it isn't quite written in stone the way most
              beginner tutorials might lead you to believe.
            </p>
            <p>
              ...
              super rarely-used but helpful commands here that I repeatedly forget the syntax for.
            </p>

            <h4>Global Gitignore</h4>
            <p>
              Let's start with something you may already know. You're probably aware that if you create a file called
              <code>.gitignore</code> in your Git project and add some ignore rules, Git will automatically ignore any
              files that match those rules. What you may not know is that you can create a global ignore file which will
              apply globally across all projects. Try creating one in your home directory that looks like this:
            </p>
          </div>
          ...
          <div className="col-md-2 d-none d-md-block image-caption">
            <p>~/.gitignore</p>
          </div>
...
`}
            ...
            <p className="image-caption-sm d-md-none">~/.gitignore</p>
...
git reset --hard HEAD~`}
        ...
        <Image
          src="/img/blog-git-cherrypick.png"
          width={8}
          caption="Git cherry-pick can help you out of tight spots."
        />
        ...
        <Image src="/img/blog-git-rebase.png" width={8} caption="Git rebase can be used instead of merge." />
