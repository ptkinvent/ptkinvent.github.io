  ...
  return (
    <article className="prose prose-neutral dark:prose-invert prose-pre:bg-transparent prose-pre:p-0 mx-auto max-w-3xl px-4 pb-20 sm:px-6">
      <p>
        ...
        <a href="https://gohugo.io/">Hugo</a> will suffice. But for building more complex websites with forms, user
        login, and database interaction, you'll need to develop a full web app with a backend using one of many
        frameworks, such as .NET, Java, Ruby on Rails, and more. The purpose of this post is to walk you through
        deploying a working Python web app to a production server. We'll focus on{" "}
        ...
        and{" "}
        <a target="_blank" rel="noopener noreferrer" href="https://fastapi.tiangolo.com/">
          FastAPI
        </a>
        .
      </p>
      <p>
        This blog post is part of a series of posts about how to deploy a Django app to AWS. If you haven't created
        your EC2 instance yet, follow the instructions in{" "}
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://docs.djangoproject.com/en/5.2/intro/tutorial01/">
          Django tutorial
        </a>
      ...
      <p>
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://gunicorn.org/">
          Gunicorn
        </a>{" "}
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://uwsgi-docs.readthedocs.io/en/latest/">
          uwsgi
        </a>
        ,{" "}
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/django/daphne">
          Daphne
        </a>
        , and{" "}
        <a target="_blank" rel="noopener noreferrer" href="https://www.uvicorn.org/">
          uvicorn
        </a>{" "}
      ...
      <p>
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://aws.amazon.com/elasticbeanstalk/">
        ...
        would make it much more straightforward to deploy our Django project, but tend to cost more and hide a lot of
        implementation details. Instead, for this tutorial we'll explore deploying our app server by hand for the
        purposes of understanding all the pieces.
      </p>
      ...
      <p>
        ...
        been placed there when you created your Django project for the first time. Note down the name of the folder
        this <code>wsgi.py</code> file is in, e.g. <code>myappname/</code>. Let's install Gunicorn and point it to
        this file to run your app.
      </p>
      <ol>
        <li>
...
gunicorn --workers 4 --bind 0:8000 myappname.wsgi:application`}
      ...
      <p>
        ...
        Gunicorn every time, we simply point Gunicorn to a config file containing these options instead, and run it
        with <code>gunicorn -c /path/to/config.py</code>. Here's a sample config file you can store at{" "}
...
max_requests_jitter = 90`}
      ...
      <p>
        Now that Gunicorn is successfully launched and running on port 8000, we simply need to hook it up to NGINX so
        that it can be served at port 443, which is where HTTPS traffic is served. Modify your{" "}
...
stderr_logfile=/var/log/supervisor/django-gunicorn-err.log`}
      ...
      <p>
        ...
        personal project, but if you want to launch a web app that supports hundreds or thousands of users, there's
        still a long road ahead: static storage and databases and load balancing, oh my! Perhaps best saved for
        another blog post. Until then, happy serving!
      </p>
    </article>
  );
}
