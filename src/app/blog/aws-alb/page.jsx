        ...
        <div className="row">
          <div className="offset-xl-3 col-xl-6 offset-lg-2 col-lg-8">
            <p>
              ...
              variables on our EC2 machine. This also won't scale, since creating, updating, or deleting these secrets
              will get cumbersome as we increase the number of servers. More importantly, this also isn't a secure way
              to store secrets since anyone with access to our server can access these secrets. Instead, we'll use{" "}
            ...
            <p>
              ...
              Let's continue using environment variables for local development so we aren't reliant on an Internet
              connection. Modify <code>settings.py</code> to look like the following:
            </p>
          </div>
        </div>
