...
import photographyCherryBlossoms from "@/assets/img/photography-cherry-blossoms.jpg";
...
export default function PhotoGrid() {
  ...
  const items = [
    ...
    { src: photographyMchenryOverhead, dateTaken: "11/09/2024", caption: "Fort McHenry, MD" },
    { src: photographyMchenry, dateTaken: "11/09/2024", caption: "Fort McHenry from above" },
